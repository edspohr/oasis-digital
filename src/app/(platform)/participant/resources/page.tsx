...
export default function ResourcesPage() {
    ...
    return (
        <div className="space-y-8">
            <div>
                <h1 className="font-heading text-3xl font-bold text-gray-800">Biblioteca de Recursos</h1>
                <p className="text-gray-600">Herramientas rápidas para momentos que importan.</p>
            </div>
